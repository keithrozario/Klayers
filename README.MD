...
python-Levenshtein-wheels| arn:aws:lambda:\<*region*>:113088814899:layer:Klayers-python37-python-Levenshtein-wheels:\<*version*> |
...
Make a pull requests, modifying the `serverless/config/Klayers-default.csv` file.
