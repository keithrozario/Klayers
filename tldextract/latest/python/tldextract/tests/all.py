...
extract_using_real_local_suffix_list_no_cache = tldextract.TLDExtract(
    cache_file=False)
...
class ExtractTest(unittest.TestCase):
    ...
    def test_local_host(self):
        self.assertExtract(
            '', 'internalunlikelyhostname', '', 'http://internalunlikelyhostname/')
        self.assertExtract('internalunlikelyhostname', 'bizarre',
                           '', 'http://internalunlikelyhostname.bizarre')

    def test_qualified_local_host(self):
        self.assertExtract(
            '', 'internalunlikelyhostname', 'info', 'http://internalunlikelyhostname.info/')
        self.assertExtract('internalunlikelyhostname', 'information',
                           '', 'http://internalunlikelyhostname.information/')

    def test_ip(self):
        self.assertExtract('', '216.22.0.192', '', 'http://216.22.0.192/')
        self.assertExtract(
            '216.22', 'project', 'coop', 'http://216.22.project.coop/')
    ...
    def test_punycode(self):
        self.assertExtract(
            '', u'россия', u'рф', 'http://xn--h1alffa9f.xn--p1ai')
    ...
    def test_scheme(self):
        ...
        self.assertExtract(
            'mail', 'google', 'com', 'ssh://mail.google.com/mail')
        self.assertExtract('mail', 'google', 'com', '//mail.google.com/mail')
        self.assertExtract(
            'mail', 'google', 'com', 'mail.google.com/mail', fns=(extract,))
    ...
    def test_username(self):
        self.assertExtract(
            '1337', 'warez', 'com', 'ftp://johndoe:5cr1p7k1dd13@1337.warez.com:2501')
    ...
    def test_query_fragment(self):
        ...
        self.assertExtract(
            '', 'google', 'com', 'http://google.com/s?q=cats#Welcome')

    def test_regex_order(self):
        self.assertExtract(
            'www', 'parliament', 'uk', 'http://www.parliament.uk')
        self.assertExtract(
            'www', 'parliament', 'co.uk', 'http://www.parliament.co.uk')

    def test_unhandled_by_iana(self):
        self.assertExtract(
            'www', 'cgs', 'act.edu.au', 'http://www.cgs.act.edu.au/')
        self.assertExtract(
            'www', 'google', 'com.au', 'http://www.google.com.au/')
    ...
    def test_private_domains(self):
        self.assertExtract(
            'waiterrant', 'blogspot', 'com', 'http://waiterrant.blogspot.com')
...
def test_suite():
    return unittest.TestSuite([
        ...
        unittest.TestLoader().loadTestsFromTestCase(
            ExtractTestUsingCustomSuffixListFile),
    ])
