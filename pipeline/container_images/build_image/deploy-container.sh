...
REPO_PARAM=/kl/$STAGE/build/p39/x86/repo
...
aws ssm put-parameter --name /kl/$STAGE/build/p39/x86/digest --value $DIGEST --profile $PROFILE --region $REGION --overwrite --type String | jq '.'
