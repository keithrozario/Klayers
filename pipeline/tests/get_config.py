...
def get_config(stage='Klayers-defaultp38'):
    ...
    with open('pipeline/infra/terraform.tfvars.json', 'r') as config_file:
    ...
    session = boto3.session.Session(profile_name=config['aws_profile'], region_name=config['aws_region'])
    ...
    while True:
        ...
        try:
            ...
            break
    step_function_resource_ids = [stack_resource['PhysicalResourceId'] 
