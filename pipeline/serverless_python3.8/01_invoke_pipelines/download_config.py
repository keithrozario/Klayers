...
def download_config_from_github(event, context):
    ...
    base_url = f"https://raw.githubusercontent.com/{repo_name_branch}/pipeline/config/{stage}"
    ...
    for config_file in filenames:
        ...
        object_hash = object_summary.e_tag[1:-1]  # e_tag is surrounded by double-quotes '"'
